...
export class GeneralUpdateQueryRecievedCallsListComponent implements OnInit, OnDestroy {
    ...
    /**
     *Creates an instance of GeneralUpdateQueryRecievedCallsListComponent.
     * @param {CallCenterOnlyPageService} callcenteronlypageservice
     * @param {Router} _router
     * @param {GlobalStateService} globalState
     * @memberof GeneralUpdateQueryRecievedCallsListComponent
     */
