...
import {
    SignalrWindow, ChannelConfig,
    ConnectionState, ChannelSubject,
    ChannelEvent
...
export class NotificationService {
    ...
    private connectionStateSubject: Subject<ConnectionState> = new Subject<ConnectionState>();
    private startingSubject: Subject<any> = new Subject<any>();
    ...
    private subjects: ChannelSubject[] = new Array<ChannelSubject>();
    ...
    private findObservableByChannelName(channel: string): ChannelSubject {
