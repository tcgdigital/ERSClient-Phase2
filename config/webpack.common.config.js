...
/**webpack inbuild plugins declaration*/
const NormalModuleReplacementPlugin = require('webpack/lib/NormalModuleReplacementPlugin');
const ContextReplacementPlugin = require('webpack/lib/ContextReplacementPlugin');
const CommonsChunkPlugin = require('webpack/lib/optimize/CommonsChunkPlugin');
const LoaderOptionsPlugin = require('webpack/lib/LoaderOptionsPlugin');

/**webpack external plugins declaration*/
const AssetsPlugin = require('assets-webpack-plugin');
const CopyWebpackPlugin = require('copy-webpack-plugin');
const CheckerPlugin = require('awesome-typescript-loader').CheckerPlugin;
const HtmlElementsPlugin = require('./html-elements-plugins');
...
module.exports = function (options) {
    ...
    return {
        ...
        resolve: {
             ...
             * For example, in order to discover CoffeeScript files, your array should contain the string 
        ...
        module: {
            rules: [
                 ...
                 */
                {
                    test: /\.ts$/,
                    use: [
                        /** Angular2-HMR Hot Module Reloading for Webpack 2 and Angular 2
                         */
                        {
        ...
        plugins: [
            ...
            /**Because of Bootstrap 4's removal of UMD, internal dependencies, such as Popover's dependencies on 
             * Tooltip and Dropdown's dependency on Utils, are no longer naively resolved by Webpack */
